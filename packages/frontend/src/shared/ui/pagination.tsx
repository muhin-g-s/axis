...
export const PaginationEllipsis = forwardRef<HTMLDivElement, ChakraPagination.EllipsisProps>(
  function PaginationEllipsis(props, ref) {
    ...
    return (
      <ChakraPagination.Ellipsis ref={ref as never} {...props} asChild>
...
export const PaginationItem = forwardRef<HTMLButtonElement, ChakraPagination.ItemProps>(
  function PaginationItem(props, ref) {
    ...
    return (
      <ChakraPagination.Item ref={ref as never} {...props} asChild>
...
export const PaginationPrevTrigger = forwardRef<HTMLButtonElement, ChakraPagination.PrevTriggerProps>(
  function PaginationPrevTrigger(props, ref) {
    ...
    return (
      <ChakraPagination.PrevTrigger ref={ref as never} asChild {...props}>
...
export const PaginationNextTrigger = forwardRef<HTMLButtonElement, ChakraPagination.NextTriggerProps>(
  function PaginationNextTrigger(props, ref) {
    ...
    return (
      <ChakraPagination.NextTrigger ref={ref as never} asChild {...props}>
        <IconButton variant={variantMap.default} size={size}>
          <HiChevronRight />
        </IconButton>
...
export const PaginationPageText = forwardRef<HTMLParagraphElement, PageTextProps>(
  function PaginationPageText(props, ref) {
    ...
    return (
      <Text fontWeight="medium" ref={ref as never} {...rest}>
        {content}
      </Text>
    );
  }
